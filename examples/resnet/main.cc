...
bool model_load(const std::string &fname,Model &model)
{
    ...
    size_t ctx_size = 0;
    {
        ...
        //layer1
        int channels = 64;
        ctx_size += channels*64*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer1.0.conv1.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.0.bn1.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.0.bn1.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.0.bn1.running_mean
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.0.bn1.running_var
        
        ctx_size += channels*channels*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer1.0.conv2.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.0.bn2.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.0.bn2.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.0.bn2.running_mean
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.0.bn2.running_var


        ctx_size += channels*64*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer1.1.conv1.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.1.bn1.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.1.bn1.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.1.bn1.running_mean
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.1.bn1.running_var
        
        ctx_size += channels*channels*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer1.1.conv2.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.1.bn2.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.1.bn2.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer1.1.bn2.running_mean
        ...
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.bn1.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.bn1.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.bn1.running_mean
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.bn1.running_var
        
        ctx_size += channels*channels*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.conv2.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.bn2.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.bn2.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.bn2.running_mean
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.bn2.running_var

        ctx_size += channels*64*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.downsample.0.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.downsample.1.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.downsample.1.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.downsample.1.running_mean 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.0.downsample.1.running_var 



        ctx_size += channels*channels*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer2.1.conv1.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.1.bn1.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.1.bn1.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.1.bn1.running_mean
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.1.bn1.running_var
        
        ctx_size += channels*128*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer2.1.conv2.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer2.1.bn2.weight 
        ...
        //layer3
        channels = 256;
        ctx_size += channels*128*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.conv1.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.bn1.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.bn1.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.bn1.running_mean
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.bn1.running_var
        
        ctx_size += channels*channels*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.conv2.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.bn2.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.bn2.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.bn2.running_mean
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.bn2.running_var

        ctx_size += channels*128*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.downsample.0.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.downsample.1.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.downsample.1.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.downsample.1.running_mean 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.0.downsample.1.running_var 



        ctx_size += channels*channels*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer3.1.conv1.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.1.bn1.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.1.bn1.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.1.bn1.running_mean
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.1.bn1.running_var
        
        ctx_size += channels*channels*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer3.1.conv2.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.1.bn2.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer3.1.bn2.bias
        ...
        //layer4
        channels = 512;
        ctx_size += channels*256*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.conv1.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.bn1.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.bn1.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.bn1.running_mean
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.bn1.running_var
        
        ctx_size += channels*channels*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.conv2.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.bn2.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.bn2.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.bn2.running_mean
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.bn2.running_var

        ctx_size += channels*256*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.downsample.0.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.downsample.1.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.downsample.1.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.downsample.1.running_mean 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.0.downsample.1.running_var 



        ctx_size += channels*channels*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer4.1.conv1.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.1.bn1.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.1.bn1.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.1.bn1.running_mean
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.1.bn1.running_var
        
        ctx_size += channels*channels*3*3*ggml_type_sizef(GGML_TYPE_F32);//layer4.1.conv2.weight
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.1.bn2.weight 
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.1.bn2.bias
        ctx_size += channels*ggml_type_sizef(GGML_TYPE_F32);//layer4.1.bn2.running_mean
    ...
    for(int i = 0; i < layer_count; i++)
    {
        ...
        for(int b = 0; b < 2; b++)
        {
            //conv1
            {
                ...
                model.layers[i].blocks[b].conv1.weight = ggml_new_tensor_4d(model.ctx,GGML_TYPE_F32,ne_weight[0],ne_weight[1],ne_weight[2],ne_weight[3]);
...
static ggml_tensor * apply_conv2d(ggml_context * ctx, ggml_tensor * input, const conv2d_layer & layer,bool relu=true)
{
