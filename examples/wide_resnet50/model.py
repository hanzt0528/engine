...
class BasicBlock(nn.Module):
    ...
    def __init__(self, first_channels,second_channels ,third_channels, stride=1, downsample=None):
        ...
        self.conv1 = nn.Conv2d(first_channels ,second_channels, kernel_size=1, stride=1, padding=0, bias=False)
        self.bn1 = nn.BatchNorm2d(second_channels)
        
        self.conv2 = nn.Conv2d(second_channels, second_channels, kernel_size=3, stride=stride, padding=1, bias=False)
