...
// /usr/local/cuda/bin/nvcc cublas_sgemm.cu -l cublas
// /opt/nvidia/nsight-systems/2022.4.1/bin/nsys profile --stats=true ./a.out 
...
int main(void) {
    ...
    const int M_list[15] = {128, 192, 256, 384, 512, 768, 1024, 1536, 2048, 3072, 4096, 6144, 8192, 12288, 5120};
    const int N_list[15] = {128, 192, 256, 384, 512, 768, 1024, 1536, 2048, 3072, 4096, 6144, 8192, 12288, 5120};
    const int K_list[15] = {1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 5120};
